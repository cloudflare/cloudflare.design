...
const SectionFigma = ({ variant, ...props }) => {
  switch (variant) {
    case "default":
      return (
      <section>
        ...
        <Text>
          As we've been making the transition to Figma, we've been building some
          plugins to help us with common workflows.
        </Text>
        <div sx={{ mt: 5, maxWidth: "64em", mx: "auto" }}>
          <div sx={{ display: "flex", flexWrap: ['wrap', 'nowrap'], mx: [0, -3] }}>
          ...
          <article sx={{ mt: 5 }}>
            ...
            >
              ...
              >
                ...
                interesting one. Things that are often tedious and done by hand
                can easily be automated if we have access to the underlying code
                of the tool, therefore giving designers more time to work on the
                meaningful parts of their process, like designing."
              </span>
              <div
                sx={{
                  display: "flex",
          ...
          <div sx={{ display: "flex", flexWrap: ['wrap', 'nowrap'],p: 3 }}>
              <div sx={{ width: '100%', p: 3}}>
                <a
                  ...
                  sx={{
                    display: 'block',
                    backgroundImage: "url(https://cloudflare-assets.s3.us-east-1.amazonaws.com/photos/color-blind.png)",
              ...
              <a
                ...
                sx={{
                  display: 'block',
                  backgroundImage: "url(https://cloudflare-assets.s3.us-east-1.amazonaws.com/photos/translate.png)",
                  backgroundSize: 'cover',
                  minHeight: 192,
                  width: '100%',
                  height: '100%'
              ...
              <a
                ...
                sx={{
                  display: 'block',
                  backgroundImage: "url(https://cloudflare-assets.s3.us-east-1.amazonaws.com/photos/charts.png)",
                  backgroundSize: 'cover',
                  minHeight: 192,
                  width: '100%',
                  height: '100%'
