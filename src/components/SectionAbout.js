      ...
      return (
        ...
        <div sx={{px: 4, maxWidth: '64em', mx: 'auto'}}>
            ...
            <p sx={{
              ...
              design of this page to be configured and updated by anyone. That's right,
              anyone can update the design of this page.         </p>
        ...
        <p sx={{lineHeight: 1.5, fontSize: [4,5,5] }}>
              Each section comes with multiple design variants that can
              be combined with a variety of color themes. Once you are happy with the
              design, you can publish your design live to cloudflare.design.  
